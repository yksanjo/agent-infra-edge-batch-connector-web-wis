# agent-infra-edge-batch-connector-web-wis

## Detailed Description

agent-infra-edge-batch-connector-web-wis is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
